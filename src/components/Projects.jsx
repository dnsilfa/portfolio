...
const projects = [
  {
    ...
    links: {
      github: 'https://github.com/natashasthilaire/Swampy-Sells',
    },
    accent: 'var(--accent)',
  },
  {
  ...
  },
  {
    name: 'Basic Compiler',
    period: 'Jan – Apr 2023',
    description: 'Custom compiler implemented in Java: lexical scanner, parser, type-checker, and code-generator to emit Java from a defined grammar.',
    tags: ['Java', 'Compilers', 'Parsing'],
    links: {},
    accent: 'var(--accent-warm)',
  },
  {
    name: 'Custom Message Logging (Linux)',
    period: 'Oct 2022',
    description: 'Message-logging system implemented on top of the Linux kernel diagnostic logger with custom system calls and a static C API.',
    tags: ['C', 'Linux', 'Systems'],
    links: {},
    accent: 'var(--bg-card)',
  },
  {
    name: 'COVID-19 Web Scraper (ShellHacks)',
    period: 'Sep 2020',
    description: 'Scraped state-level COVID-19 statistics and built a Pygame GUI to display and sort results during a hackathon.',
    tags: ['Python', 'Pygame', 'Web Scraping'],
    links: {},
    accent: 'var(--accent-2)',
  },
